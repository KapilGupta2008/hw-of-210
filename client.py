...
def openChatWindow():
    ...
    play=Button(window,text="play",bd=1, font = ("Calibri",10), command = connectWithClient)
    play.place(x=282,y=160)

   
    pause=Button(window,text="pause",bd=1, font = ("Calibri",10),command=disconnectWithClient)
    pause.place(x=350,y=160)
